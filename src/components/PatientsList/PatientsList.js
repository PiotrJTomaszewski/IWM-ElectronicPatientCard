      ...
      return (
        <div>
          <div className="md-form m-4">
              <input onKeyUp={filterNamesCallback} id="filter-box" className="form-control" type="text" placeholder="Filter family names" aria-label="Filter family names"/>
          </div>
          <Table striped hover>
            <thead>
              <tr>
